...
const double MIN_SAFE_DISTANCE_90_DEG = 1.0;
const double MIN_SAFE_DISTANCE_15_DEG = 1.0 / cos(15 * PI / 180);
const double MIN_SAFE_DISTANCE_30_DEG = 1.0 / cos(30 * PI / 180);
const double MIN_SAFE_DISTANCE_45_DEG = 1.0 / cos(45 * PI / 180);
